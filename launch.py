...
def prepare_environment():
    ...
    commandline_args = os.environ.get(
        'COMMANDLINE_ARGS', "--skip-python-version-check --skip-torch-cuda-test --enable-insecure-extension-access")
    ...
    parser.add_argument("--ui-settings-file", type=str,
                        help="filename to use for ui settings", default='config.json')
