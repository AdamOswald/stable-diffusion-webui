...
def create_seed_inputs(target_interface):
    with FormRow(elem_id=f'{target_interface}_seed_row'):
        ...
        random_seed = gr.Button(
            random_symbol, elem_id=f'{target_interface}_random_seed'
        )
        reuse_seed = gr.Button(reuse_symbol, elem_id=f'{target_interface}_reuse_seed')

        with gr.Group(elem_id=f'{target_interface}_subseed_show_box'):
...
def create_ui():
    ...
    with gr.Blocks(css=css, analytics_enabled=False, title="Stable Diffusion") as demo:
        ...
        button_set_checkpoint = gr.Button('Change checkpoint', elem_id='change_checkpoint', visible=True)
